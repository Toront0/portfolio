...
import eye from "../../../public/left-eye.png";
...
const GopherLogo = () => {
  ...
  const eyeRef = useRef<HTMLImageElement>();
  const eyeRef2 = useRef<HTMLImageElement>();
  ...
  useLayoutEffect(() => {
    ...
    if (eyeRef.current && eyeRef2.current) {
      ...
      eyeRef2.current.style.transform = `rotate(${angleDeg}deg)`;
    }
  }, [x, y]);
  ...
  return (
    <div
      ...
      className="relative "
    >
      <div className="absolute top-14 left-[38px]">
        <img
          ref={eyeRef as React.RefObject<HTMLImageElement>}
          src={eye.src}
          alt=""
          className="w-10  h-10"
        />
      </div>
      <div className="absolute top-14  left-[88px]">
        <img
          ref={eyeRef2 as React.RefObject<HTMLImageElement>}
          src={eye.src}
          alt=""
          className="w-10 h-10"
        />
